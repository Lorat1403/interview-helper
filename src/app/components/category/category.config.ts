...
export const MOCK_DATA: MockDataStructure = {
  angular: [
    ...
    },
    {
      ...
      answer:'Щоб створити новий компонент в Angular, ви використовуєте команду Angular CLI ng generate component <назва-компонента>. Ця команда автоматично генерує всі необхідні файли для компонента (файл класу .ts, шаблон .html, стилі .css або .scss та файл тестування .spec.ts). CLI також автоматично реєструє або декларує новий компонент у найближчому модулі Angular (зазвичай AppModule). Ви також можете використовувати скорочену команду ng g c <назва-компонента>.',
    },
    {
      id: 5,
